...
has some handler that turns that into "elements where `el.disabled === true`". This is a pretty high-level abstraction;
could we explain it with technology instead of magic? What about some kind of **CSS selector registration**?
